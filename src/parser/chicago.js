...
function parseGenericEntry(entry, options = {}) {
  ...
  return {
    ...
    doi,
    url,
    sourceType: options.sourceType || "article-journal",
  };
}

export function parseChicagoEntry(entry) {
  return parseGenericEntry(entry, { sourceType: "article-journal" });
}